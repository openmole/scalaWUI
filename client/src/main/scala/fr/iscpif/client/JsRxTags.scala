...
object JsRxTags {
  ...
  implicit def rxTypedTagToElement[T <: TypedTag[HTMLElement]](r: Rx[T]): HTMLElement= {
  ...
  /**
    ...
    */
  implicit def rxMod[T <: dom.raw.HTMLElement](r: Rx[HtmlTag]): Modifier = bindNode(rxTypedTagToElement(r))
